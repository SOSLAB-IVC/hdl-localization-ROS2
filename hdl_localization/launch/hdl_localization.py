...
def generate_launch_description():
    ...
    odom_child_frame_id = LaunchConfiguration('odom_child_frame_id', default='base_scan') 
    imu_topic = LaunchConfiguration('imu_topic', default='/imu')
    globalmap_pcd = DeclareLaunchArgument('globalmap_pcd', default_value='/root/ros2_ws/src/map.pcd', description='Path to the global map PCD file')
